...
def execute(file_id, force=False):
    ...
    vocalsfile = filestore.retrieve_file(file_id, f"{Tasks.STEM.value}-vocals.wav", scratch)
    ...
    for fmt in output_fmts:
        output[fmt] = filestore.store_file(file_id, outdir + f"/{filebase}.{fmt}", f"{Tasks.LYRC.value}.{fmt}")
